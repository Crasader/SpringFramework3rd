...
<body>
    <form name="fixedDepositList" method="post"
        ...
        <table align="left" style="padding-left: 300px;">
            <tr>
                <td style="font-family: 'arial'; font-size: 16px; font-weight: bold;">Fixed
                    deposit list new</td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                ...
                <td>
                    <table class="border" cellpadding="10">
                        ...
                        <c:forEach items="${fdList}" var="fixedDeposit">
                            <tr>
                                <td class="td"><c:out value="${fixedDeposit.fixedDepositId}" /></td>
                                <td class="td"><c:out value="${fixedDeposit.fdAmount}" /></td>
                                <td class="td"><c:out value="${fixedDeposit.tenure}" /></td>
                                <td class="td"><c:out value="${fixedDeposit.email}" /></td>
                                <td class="td"><a
                                        href="${pageContext.request.contextPath}/fixedDeposit?fdAction=close&fixedDepositId=${fixedDeposit.fixedDepositId}"
                                        style="color: green">Close</a> <a
                                        href="${pageContext.request.contextPath}/fixedDeposit?fdAction=view&fixedDepositId=${fixedDeposit.fixedDepositId}"
